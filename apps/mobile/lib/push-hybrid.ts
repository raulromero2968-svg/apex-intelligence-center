...
export const setupForegroundNotificationHandler = (...args: any[]) => {};
export const setupNotificationResponseHandler = (...args: any[]) => {};
export const setupTokenRefreshListener = (...args: any[]) => {};
