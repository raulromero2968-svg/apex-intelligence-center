          ...
          <div className="space-y-4">
            ...
            {workflow.triggerType === "webhook" && (
              <div>
                ...
                <div className="px-3 py-2 bg-slate-800/50 border border-slate-700 rounded text-sm text-slate-400 font-mono">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 bg-slate-800/50 border border-slate-700 rounded text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:border-violet-500 resize-none font-mono"
              />
            </div>
