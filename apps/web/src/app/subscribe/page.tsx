      ...
      <section className="relative z-10 px-6 md:px-12 py-8 flex-1 flex items-center justify-center">
        <div className="w-full max-w-xl">
          <HoloCard intensity="high">
            {/* Terminal Header */}
            <div className="flex items-center gap-2 mb-6 text-sm font-sans text-cyan-400">
            ...
            <h2 className="text-2xl font-bold text-white mb-2 text-center font-sans">
            ...
            <form className="space-y-5">
              ...
              <div>
                <label htmlFor="name" className="block text-sm font-sans text-slate-500 mb-2">
                  CODENAME (optional)
                </label>
                <input
                  type="text"
                  ...
                  className="w-full rounded-lg bg-slate-900/80 px-4 py-4 text-white placeholder-slate-500 border border-slate-700 focus:border-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-400/30 transition font-sans"
                />
              </div>

              <button
                type="submit"
                className="w-full rounded-lg bg-cyan-500 hover:bg-cyan-400 px-6 py-4 font-bold text-black transition-all text-lg shadow-[0_0_30px_rgba(6,182,212,0.5)] hover:shadow-[0_0_50px_rgba(6,182,212,0.8)] font-sans"
              >
                [ INITIATE_ACCESS ]
              </button>
            </form>

            <p className="mt-6 text-center text-sm text-slate-500 font-sans">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="border border-cyan-500/30 bg-slate-900/50 backdrop-blur-sm rounded-lg p-6 text-center">
              ...
              <h3 className="text-white font-bold text-lg mb-2 font-sans">Weekly Intel Drops</h3>
            ...
            <div className="border border-purple-500/30 bg-slate-900/50 backdrop-blur-sm rounded-lg p-6 text-center">
              ...
              <h3 className="text-white font-bold text-lg mb-2 font-sans">Early Access</h3>
              <p className="text-sm text-slate-400">
            ...
            <div className="border border-cyan-500/30 bg-slate-900/50 backdrop-blur-sm rounded-lg p-6 text-center">
              ...
              <h3 className="text-white font-bold text-lg mb-2 font-sans">Exclusive Research</h3>
              <p className="text-sm text-slate-400">
      ...
      <section className="relative z-10 px-6 md:px-12 py-16">
        <div className="max-w-3xl mx-auto">
          <div className="relative border border-slate-700 bg-slate-900/50 backdrop-blur-sm rounded-xl p-8">
            ...
            <div className="flex items-center gap-2 mb-6 text-sm font-sans text-slate-500">
              <div className="flex gap-1.5">
            ...
            <div className="space-y-4 text-slate-300">
              <div className="flex items-start gap-3">
                ...
                <p><strong className="text-white font-sans">Market Pulse</strong> — Weekly summary of major TCG market movements</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-cyan-400 font-sans">02.</span>
                <p><strong className="text-white font-sans">Deep Dives</strong> — In-depth analysis of specific sets, cards, or trends</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-cyan-400 font-sans">03.</span>
                <p><strong className="text-white font-sans">Alpha Alerts</strong> — Time-sensitive opportunities and market signals</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-cyan-400 font-sans">04.</span>
                <p><strong className="text-white font-sans">Research Reports</strong> — Data-driven analysis and forecasts</p>
              </div>
            </div>
          </div>
        </div>
