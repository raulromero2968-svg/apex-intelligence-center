          ...
          <ElectronicFolder title="OPERATIVE PROFILES" classification="ROGUE THINK TANK // APEX INTEL">
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="border border-cyan-500/30 bg-slate-900/50 backdrop-blur-sm rounded-lg p-6 hover:border-cyan-400/60 transition-all">
                  ...
                  <h3 className="text-lg font-bold text-white mb-3 font-sans">THE SERIOUS COLLECTOR</h3>
                  ...
                  <div className="mb-4">
                    <h4 className="text-cyan-400 text-xs font-sans mb-2">THEY CARE ABOUT:</h4>
                  ...
                  <div>
                    <h4 className="text-white text-xs font-sans mb-2">HOW WE SERVE THEM:</h4>
                    <ul className="space-y-1 text-xs text-slate-500 font-sans">
                      <li className="flex items-center gap-2">
                ...
                <div className="border border-purple-500/30 bg-slate-900/50 backdrop-blur-sm rounded-lg p-6 hover:border-purple-400/60 transition-all">
                  ...
                  <h3 className="text-lg font-bold text-white mb-3 font-sans">THE CURIOUS SCIENTIST</h3>
                  <p className="text-slate-400 text-sm leading-relaxed mb-4">
                  ...
                  <div className="mb-4">
                    <h4 className="text-purple-400 text-xs font-sans mb-2">THEY CARE ABOUT:</h4>
                    <ul className="space-y-1 text-xs text-slate-500 font-sans">
                      <li className="flex items-center gap-2">
                ...
                <div className="border border-cyan-500/30 bg-slate-900/50 backdrop-blur-sm rounded-lg p-6 hover:border-cyan-400/60 transition-all">
                  ...
                  <h3 className="text-lg font-bold text-white mb-3 font-sans">THE ETHICAL BUILDER</h3>
                  <p className="text-slate-400 text-sm leading-relaxed mb-4">
            ...
            <div className="relative border border-purple-500/40 bg-gradient-to-br from-purple-950/30 to-cyan-950/30 backdrop-blur-sm rounded-xl p-8 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <blockquote className="text-xl md:text-2xl text-slate-300 leading-relaxed text-center mb-6 font-sans">
          ...
          <ElectronicFolder title="LONG-TERM VISION" classification="STRATEGIC DIRECTION // 2025+">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-10">
              <div>
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white font-sans">SHORT-TERM</h3>
                </div>
              ...
              <div>
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white font-sans">LONG-TERM</h3>
                </div>
                <p className="text-slate-400 leading-relaxed">
            ...
            <div className="relative border border-slate-700/50 bg-slate-900/30 backdrop-blur-sm rounded-xl p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-lg font-bold text-white font-sans">OUR EVOLUTION</h3>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-white font-sans text-sm mb-1">MAINTAIN THE UNDERGROUND AESTHETIC</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-white font-sans text-sm mb-1">BUILD BRIDGES</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-white font-sans text-sm mb-1">COLLABORATE WITH THE FIELD</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-white font-sans text-sm mb-1">STAY ALIGNED</h4>
