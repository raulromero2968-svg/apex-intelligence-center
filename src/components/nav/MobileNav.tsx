      ...
      >
        <div className="flex items-center justify-between h-16 px-4">
          ...
          <button
            ...
            className="lg:hidden w-11 h-11 min-w-[44px] min-h-[44px] flex flex-col items-center justify-center gap-1.5 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-ink rounded-lg"
          >
            <motion.span
                ...
                {links.map((link, index) => (
                  ...
                  >
                    <Link
                      href={link.href}
                      onClick={() => setIsOpen(false)}
                      className="block min-h-[44px] px-6 py-3 rounded-lg text-white text-lg font-medium hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-400"
                    >
                      {link.label}
                    </Link>
                  </motion.div>
